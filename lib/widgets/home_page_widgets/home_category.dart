...
class CategoryTab extends StatelessWidget {
  ...
  const CategoryTab(
      ...
      this.imgLeft = 15.0,
      this.imgBottom = -8.0,
      required this.titleGrp, required this.descGrp}
  );
    ...
    switch (tabName) {
      case ("Symptomes"):
        return () => Navigator.of(context).push(MaterialPageRoute(
            builder: (context) => SymptomsScreen(color: color, imgPath: imgPath)));
      case ("Précautions"):
        return () => Navigator.of(context).push(MaterialPageRoute(
            builder: (context) => PrecautionsScreen(color: color, imgPath: imgPath)));
      case ("Mythes"):
        return () => Navigator.of(context).push(MaterialPageRoute(
            builder: (context) => MythsScreen(color: color, imgPath: imgPath)));
      case ("Covid"):
        return () => Navigator.of(context).push(MaterialPageRoute(
            builder: (context) => VirusDetailsScreen(color: color, imgPath: imgPath)));
      case ("News"):
        return () => Navigator.of(context).push(MaterialPageRoute(
