...
class AnimatedBottomBar extends StatefulWidget {
  ...
  AnimatedBottomBar(
      {required this.barItems,
        ...
        required this.elevation,required this.onItemTap, required this.currBarItem});
...
class AnimatedBarItem extends StatefulWidget {
  ...
  AnimatedBarItem({super.key, required this.isSelected, required this.thisItemIndex,required this.barItem,required this.currBarItem,required this.animationDuration, required this.elevation, required this.onItemTap});
  @override
