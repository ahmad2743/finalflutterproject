...
class NewCaseBoxes extends StatelessWidget {
  ...
  NewCaseBoxes({ Key? key, this.color,required this.affected,required this.deaths,required this.recovered,required this.tested,required this.today,required this.totalCases}) : super(key: key);
