...
class _GlobalCaseContainerState extends State<GlobalCaseContainer> {
  late CaseType _caseType;
  late Color radialStartClr, radialEndClr, radialBgClr,panelStartClr, panelFontClr, panelIconClr, panelLineClr;
  ...
  void updateRadialDial() {
    if (_caseType == CaseType.ACTIVE) {
      radialStartClr = Colors.purpleAccent;
      radialEndClr = Colors.purpleAccent;
      ...
      radialStartClr = Colors.redAccent;
      radialEndClr = Colors.redAccent;
      radialBgClr = Colors.red;
      progress = (widget.globalData["deaths"] + 0.0) / widget.globalData["cases"];
    } else if (_caseType == CaseType.RECOVERED) {
      radialStartClr = Colors.greenAccent;
      radialEndClr = Colors.greenAccent;
      radialBgClr = Colors.green;
