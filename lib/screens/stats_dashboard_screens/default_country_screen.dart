...
class DefaultCountryScreen extends StatefulWidget {
  ...
  const DefaultCountryScreen({Key? key, required this.controller}) : super(key: key);
...
class _DefaultCountryScreenState extends State<DefaultCountryScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    return CountryStatWidget(
      onBackArrow: (){
        widget.controller.animateToPage(0, duration: const Duration(milliseconds: 150), curve: Curves.easeInOut);
      },
